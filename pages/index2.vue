<template>
  <div class="w-full h-full overflow-hidden">
    <div class="pointer-events-none font-peyda z-1 m-4">
      <div
        class="parent bg-transparent border-2 h-full w-full flex flex-col justify-start"
      >
        <div class="text-indigo-500 w-full text-center text-2xl font-peyda">
          نمایشگر انباشتِ ساعتی جمعیت در مرز مهران
        </div>

        <button class="child" @click="showD = !showD">نمایش چارت</button>
        <div class="h-[50vh] w-full" v-if="filestoload.length > 0 && showD">
          <Chart
            class="child chart h-[50vh] w-full"
            title="title"
            label="label"
            :labels="xaxisData"
            :data="total"
        ...
        <div class="h-full pointer-events-none w-full"></div>
